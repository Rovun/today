...
function setUserInfo()
{
	...
	$sql = "INSERT INTO `".$pre."setting` (`name`, `val`) VALUES
										...
										('site_desc', '又一个爱优讯轻博客系统诞生'),
										('site_count', ''),
										('site_titlepre', '{$po['site_titlepre']}'),
										('site_keyword', '爱优讯,ineosn,PHP,MYSQL,轻博客,开源,轻博,qing,开源轻博,开源轻博客'),
										('regCodeSwitch','1'),
										('loginCodeSwitch','1'),
										('invite_switch','0'),
										('recomm_switch','0'),
										...
										('keep_email', 'admin,ineosn'),
										('keep_niname', 'ineosn,admin,administrator,master,webmaster,email,username,password'),
										('keep_domain', 'www,ineosn,bbs,music,map,index,register,login,tag,now,admin,recommend,discovery,myfollow,mypost,mylikes,myreplays,mynotices,edit,logout,home,gomember,location,showinfo,about,copyright,call,service,privacy,custom,read,pm,user,site'),
										('keep_rep', '操你妈,艹你妈');
										";
	mysql_query($sql);
	...
	(1, ' <h3>我们是——爱优讯网</h3> <p>爱优讯网是国内首个率先开源的轻博客系统，从六月开发，八月测试，九月上线以来。将为用户提供最好用的轻博客平台。</p> <p>爱优讯网是一个全新的、倾向于音乐话题的&ldquo;高质量内容发布和传播&rdquo;的轻博客社区。</p> <p>轻博客是介于博客与微博之间的一种网络服务，博客是倾向于表达的，微博则更倾向于社交和传播，轻博客吸收双方的优势。</p> <p>如果说微博是一份报纸，博客是一本书，那么轻博客则更像一本杂志，当然这只是从内容层面的一种形象比喻。</p> <p>既不同于微博也不同于博客，我们是一种全新的网络媒体。</p> <h3>爱优讯网面向所有喜欢音乐的朋友，无论您</h3> <p>喜欢听，或是喜欢聊，或是喜欢唱，或是喜欢写，或是喜欢创作，或是乐手，或是后期 等等... 爱优讯网正是您最佳的传播和交流平台。因为，我们只关注音乐。</p> <p>欢迎各位志同道合的朋友，到爱优讯网来发布自己的作品，也欢迎各位专业朋友的点评与指导，让我们以音乐为目标，向着让更多喜欢音乐的人，获取更多精彩的内容为目标而共同努力。</p> <p>音乐是一种伟大的艺术，爱优讯网的初衷正是希望将这种艺术升华，为您展示。</p> <h3>玩转爱优讯</h3> <p>简洁的操作，让用户简单快速地发布文字、图片、音乐、视频，采用完全的内容和兴趣导航模式，让爱优讯网成为一个全新的、真正致力于&ldquo;高质量内容发布和传播&rdquo;的轻博客社区。</p> <p>更多独有的多元化元素,可以直接上上传音乐至轻博，可直接插入虾米、雅燃等音乐，与大家分享你的音乐或你的感悟。</p> <p>以音乐为主线,以兴趣为话题，轻松快乐的参与和沟通，帮你找到你最想看到的内容、最想结识的朋友。一切都基于你的爱好，让每天都在发现兴趣的乐趣中度过。</p> <h3>立即使用</h3> <p>虽然目前是测试版本,但是您可以立即使用。无需邀请，秒速注册。迅速加入音乐大家庭中。</p> <p>爱优讯网使用了html5和css3的一些新特性,如果您使用非IE浏览器将会获得更加友好的效果。</p> '),
	...
	(3, '<h3>官方网站</h3> <p>http://www.ineosn.com</p> <h3>邮箱</h3> <p>rovun<span id="ats"></span>foxmail.com</p> <h3>交流群</h3> <p>qq group 329354214</p> <h3>商业授权</h3> <p>EMAIL:rovun@foxmail.com</p> <h3>付款地址</h3> <p><a href=\"https://me.alipay.com/ineosn\" target=\"_blank\">https://me.alipay.com/ineosn</a></p> '),
	(4, '<p>本协议适用于爱优讯网开发的爱优讯网平台。使用爱优讯网平台以及与其相关联的各项技术服务和网络服务之前，您必须同意接受本协议。若不接受本协议，您将无法使用爱优讯网平台及相关服务。</p> <p>您可以通过以下方式接受本协议：一旦您注册爱优讯账户并且发布第一条信息起，您对爱优讯网平台及其他相关服务的使用将被视为您自实际 使用起便接受了本协议的全部条款。如果需要注销用户请发送注销申请邮件，我们将删除与您有关的全部内容，您与爱优讯网所有服务都将被终止。注册账户需要用户 本人电子邮件作为注册账号，如果用户使用他人邮件账号注册并被邮件归属人举证成功者将删除用户账号及所有内容，并且一切法律责任自行承担，本站不承担任何 责任。</p> <p>爱优讯网网络平台的所有权和运营权归爱优讯网所有，并保留随时变更平台提供的信息和服务的权利。爱优讯网所提供的相关信息和服务的使用者（以下简称&ldquo;用户&rdquo;）在使用之前必须同意以下的所有条款。</p> <p>用户在爱优讯网平台上发布的信息内容由用户及爱优讯网共同所有，任何其他组织或个人未经用户本人授权同意，不得复制、转载、擅改其内容。用户不得在爱优讯网平台发布和散播任何形式的含有下列内容的信息：<br> 1）为相关法律法规所禁止；<br> 2）有悖于社会公共秩序和善良风俗；<br> 3）损害他人合法权益；<br> 4）其他爱优讯网 认为不适当在本平台发布的内容。 <br> 5）通过发布音乐的上传功能上传非用户本人拥有版权的音频媒体。 <br> 爱优讯网保留删除和变更上述相关信息的权利。</p> <p>用户应保证在爱优讯网平台的注册信息的真实、准确和完整，并在资料变更时及时更新相关信息。对于任何信息不实所导致的用户本人或第三方损害，爱优讯网不承担任何责任。用户应妥善保管个人注册信息及登录密码等资料，用户将对以其注册用户名进行的所有活动和事件负法律责任。</p> <p>爱优讯网非常强调保护用户的隐私。爱优讯网将致力于为用户提供最可靠的隐私保护措施。未经用户的特别授权，爱优讯网不会将用户信息公开或透露给任何第三 方个人或机构，但在下列情形除外：<br> 1) 根据司法机关、政府部门的强制命令提供涉及用户信息的相关资料； <br> 2) 不可抗力与不可控因素导致的信息外泄；<br> 3) 爱优讯网基于自身的合法维权需要而使用用户的相关信息。</p> <p>用户同意使用爱优讯网平台服务所潜在的风险及其一切可能的后果将完全由自己承担，爱优讯网对这些可能的风险和后果不承担任何责任。</p> <p>爱优讯网不保证爱优讯网平台提供的服务能够满足用户的所有要求，也不保证已存在的服务不会中断，对这些服务的及时性、安全 性、准确性也不作保证。对于因系统维护或升级的需要而需暂停网络服务的情形，爱优讯网将视具体情形尽可能事先在重要页面发布通知。同时，爱优讯网保留在不事先 通知用户的情况下中断或终止部分或全部服务的权利，对于因服务的中断或终止而造成的用户或第三方的任何损失，爱优讯网不承担任何责任。</p> <p>用户同意尊重和维护爱优讯网平台以及其他用户的合法权益。用户因违反有关法律、法规或协议规定中的任何条款而给爱优讯网或任何第三方造成的损失，用户同意承担由此造成的一切损害赔偿责任。</p> <p>在适用法律允许的范围内，爱优讯网保留对本协议任何条款的解释权和随时变更的权利。 爱优讯网可能会随时根据需要修改本协议的任一条款。如发生此类变更，爱优讯网会提供新版本的条款。用户在变更后对爱优讯网平台服务的使用将视为已完全接受变更后的条款。</p> <p>本协议在根据下述规定终止前，将会一直适用。当下列情况出现时，爱优讯网可以随时中止与用户的协议：<br> 1) 用户违反了本协议中的任何规定；<br> 2) 法律法规要求终止本协议;<br> 3) 爱优讯网认为实际情形不再适宜继续执行本协议。</p> <p>本协议及因本协议产生的一切法律关系及纠纷，均适用中华人民共和国法律。用户与爱优讯网在此同意以爱优讯网营业所在地法院管辖。</p> '),
	(5, ' <h3>隐私政策</h3> <p>当您在使用我们的服务时，我们将致力于为您提供最可靠的隐私保护措施。未经用户的特别授权，我们承诺不会将用户信息 公开或透露给任何第三方个人或机构，但在下列情形除外：<br> 1) 根据司法机关、政府部门的强制命令提供涉及用户信息的相关资料；<br> 2) 不可抗力与不可控因素导致的信息外泄； <br> 3) 爱优讯网基于自身的合法维权需要而使用用户的相关信息。</p> <p>为了更好地提升爱优讯网的服务质量和进行更精准的网络数据分析，我们将在充分保护用户个人隐私的前提下，对用户数据库进行分析和处理。所有相关的数据分析结果都将被用于有价值的新产品的研发和用户体验的进一步改进。</p> <h3>法律声明</h3> <p>爱优讯网网络平台的所有权和运营权归爱优讯网所有，并保留随时变更平台提供的信息和服务的权利。爱优讯网所提供的相关信息和服务的使用者（以下简称&ldquo;用户&rdquo;）在使用之前必须同意以下的所有条款。</p> <p>用户在爱优讯网平台上发布的信息内容由用户及爱优讯网共同所有，任何其他组织或个人未经用户本人授权同意，不得复制、转载、 擅改其内容。用户不得在点 点网平台发布和散播任何形式的含有下列内容的信息：1）为相关法律法规所禁止；2）有悖于社会公共秩序和善良风俗；3）损害他人合法权益；4）其他爱优讯网 认为不适当在本平台发布的内容。 爱优讯网保留删除和变更上述相关信息的权利。</p> <p>用户应保证在爱优讯网平台的注册信息的真实、准确和完整，并在资料变更时及时更新相关信息。对于任何信息不实所导致的用户本人或第三方损害，爱优讯网不承担任何责任。用户应妥善保管个人注册信息及登录密码等资料，用户将对以其注册用户名进行的所有活动和事件负法律责任。</p> <p>爱优讯网非常强调保护用户的隐私。爱优讯网将致力于为用户提供最可靠的隐私保护措施。未经用户的特别授权，爱优讯网不会将用户 信息公开或透露给任何第三 方个人或机构，但在下列情形除外：1) 根据司法机关、政府部门的强制命令提供涉及用户信息的相关资料； 2) 不可抗力与不可控因素导致的信息外泄； 3) 爱优讯网基于自身的合法维权需要而使用用户的相关信息。</p> <p>用户同意使用爱优讯网平台服务所潜在的风险及其一切可能的后果将完全由自己承担，爱优讯网对这些可能的风险和后果不承担任何责任。</p> <p>爱优讯网不保证爱优讯网平台提供的服务能够满足用户的所有要求，也不保证已存在的服务不会中断，对这些服务的及时性、安全 性、准确性也不作保证。对于 因系统维护或升级的需要而需暂停网络服务的情形，爱优讯网将视具体情形尽可能事先在重要页面发布通知。同时，爱优讯网保留在不事先通知用户的情况下中断或终止 部分或全部服务的权利，对于因服务的中断或终止而造成的用户或第三方的任何损失，爱优讯网不承担任何责任。</p> <p>用户同意尊重和维护爱优讯网平台以及其他用户的合法权益。用户因违反有关法律、法规或协议规定中的任何条款而给爱优讯网或任何第三方造成的损失，用户同意承担由此造成的一切损害赔偿责任。</p> <p>在适用法律允许的范围内，爱优讯网保留对本协议任何条款的解释权和随时变更的权利。 爱优讯网可能会随时根据需要修改本协议的任一条款。如发生此类变更，爱优讯网会提供新版本的条款。用户在变更后对爱优讯网平台服务的使用将视为已完全接受变更后的条款。</p> <p>本协议在根据下述规定终止前，将会一直适用。当下列情况出现时，爱优讯网可以随时中止与用户的协议：1) 用户违反了本协议中的任何规定；2) 法律法规要求终止本协议;3) 爱优讯网认为实际情形不再适宜继续执行本协议。</p> <p>本协议及因本协议产生的一切法律关系及纠纷，均适用中华人民共和国法律。用户与爱优讯网在此同意以爱优讯网营业所在地法院管辖。</p> ');
	";
